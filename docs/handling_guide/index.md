...
|-|-:|-|
|Container Type| 2 byte | 8種のパターンを持ち、リアルタイムor非リアルタイム/拡張ヘッダ有無/フラグメント有無 の組み合わせ|
...
CDV版では以下のようになっている
|header field name|length| description|
|Container Type| 2byte | 8種のパターンを持ち、リアルタイムor非リアルタイム/拡張ヘッダ有無/フラグメント有無 の組み合わせ|
